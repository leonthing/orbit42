...
export function Sidebar({ username }: { username: string }) {
  ...
  return (
    <aside
      className={`flex h-screen flex-col border-r border-charcoal-800/60 bg-[#0d0d14] transition-all ${
        collapsed ? "w-16" : "w-56"
      }`}
    >
      {/* Logo */}
      <div className="flex h-14 items-center gap-2 border-b border-charcoal-800/60 px-4">
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-navy-600/20">
      ...
      <div className="border-t border-charcoal-800/60 p-2">
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-charcoal-500 hover:bg-charcoal-800/50 hover:text-red-400"
        >
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
