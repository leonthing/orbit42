  ...
  return (
    <>
      <button
        ...
        title="피드에 공유"
        className="rounded p-0.5 text-charcoal-500 hover:bg-charcoal-700/50 hover:text-navy-300"
      >
        ...
        <>
          ...
          <div className="fixed left-1/2 top-1/2 z-50 w-[92vw] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl border border-charcoal-800/60 bg-[rgb(var(--bg-surface))] p-5 shadow-2xl">
            ...
            <textarea
              ...
              className="mt-3 w-full rounded-lg border border-charcoal-800/60 bg-charcoal-900/30 p-3 text-sm text-charcoal-100 placeholder:text-charcoal-500 focus:border-navy-400/50 focus:outline-none"
            />
