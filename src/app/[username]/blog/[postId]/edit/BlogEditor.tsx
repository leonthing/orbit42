        ...
        <div className="mb-3 space-y-3 rounded-xl border border-charcoal-700 bg-charcoal-800/30 p-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-charcoal-700 bg-charcoal-800/50 px-3 py-1.5 text-sm text-charcoal-100 placeholder:text-charcoal-600 focus:border-navy-500 focus:outline-none"
            />
          </div>
        </div>
      )}
